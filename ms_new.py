...
if config["cv_alg"]:
    ST.CVSTRATEGY = config["cv_alg"]

device_list = config["devices"]
if device_list:
    auto_setup(__file__, devices=device_list)

free_count = 0
check_triggle_count = 3
light_lock = False
wait_timeout = config["wait_time"]

bag_temp = Template(r"tpl1662842285932.png", record_pos=(-0.418, -0.216), resolution=(1280, 720))
